...
On command 'p' print the dictionary that contains all variables. The output should look something like this:

{'quote': False, 's': 'xyz', 'tag': False, 'c': 'x', 'out': ''}

If a variable name follows the 'p', print the value of the variable in a form
